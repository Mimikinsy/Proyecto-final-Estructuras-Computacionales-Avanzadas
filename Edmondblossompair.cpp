/* Algoritmo de emparejamiento de Edmond (Blossom)
    ...
    Propósito general:
       Encontrar el matching maximo (emparejamientos maximos) de cualquier tipo de grafo menos ponderados
...
int main() {
    ...
    cout << "Este programa permite al usuario encontrar el emparejamiento maximo en un grafo que ingrese\n";
    cout << "utilizando el Algoritmo Blossom (Edmonds).\n";
    ...
    cout << "\nEl matching maximo es de: " << max_matching << "\n";
